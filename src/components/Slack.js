...
const Slack = () => {
  ...
  const sendHandler = () => {
    ...
    axios
      .post("https://slack-c8f5d-default-rtdb.firebaseio.com/slack.json", obj)
      .then(() => {
        getData();
      });
    setInputValue("");
  ...
  const deleteHandler = (key) => {
    axios
      .delete(
        `https://slack-c8f5d-default-rtdb.firebaseio.com/slack/${key}.json`
      )
      .then(() => {
        getData();
      });
  ...
  const getData = () => {
    axios
      .get("https://slack-c8f5d-default-rtdb.firebaseio.com/slack.json")
      .then((response) => {
        const finalData = [];
    ...
    <div className="homediv">
      ...
      <div className="randomContainer">
        <div className="emoji">
          ...
          <div>
            <h2 className="text">You've found the #slack-clone channel </h2>
            <p className="text">
        ...
        <div className="user">
          ...
          <div className="rando">
            ...
            <p className="joined">joined #slack-clone</p>
          </div>
        </div>
        <div>
          {data.map((ele) => {
